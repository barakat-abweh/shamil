...
public function setDatabase($database){
   ...
   public function search(){
       ...
       $user->setId();
       if(is_numeric($this->in)){
           $query="SELECT `property_id`, `property_name`, `owner_id`, `area`, `city_id`, `description`, `price`, `type`, `creation_date` FROM `property` WHERE `deleted`=0 AND `city_id`=";
